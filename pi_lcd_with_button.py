...
# Ali found these useful during development - 24/Jun/13
...
# Raspberry Pi
#
# Author : Ali Craigmile
# Site   : http://ali.craigmile.com
#
# Date   : 24/Jun/13

# The wiring for the LCD is as follows:
# Module Control With Backlight Switch | Raspberry Pi Spy
# 2 : 5V
# 3 : Contrast (0-5V)*
...
def main():
  ...
  while 1:
    if GPIO.input(BUTTON):
      ...
      lcd_byte(LCD_LINE_2, LCD_CMD)
      lcd_string(ip)
      time.sleep(10) # 20 second delay

      # Turn off backlight
      GPIO.output(LCD_BACKLIGHT, False)

      # Repeat in approximately 1 minute
      time.sleep(44)
